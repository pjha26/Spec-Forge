    ...
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-[10px] font-mono px-1.5 py-0.5 rounded ml-1"
          style={{ background: "rgba(var(--primary-rgb),0.12)", color: "hsl(var(--primary))", border: "1px solid rgba(var(--primary-rgb),0.22)" }}
        >
          AI
        </span>
      </div>
          ...
          >
            ...
            <div className="rounded-lg overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
              <div className="flex items-center justify-between px-3 py-2"
                style={{ background: "rgba(var(--primary-rgb),0.08)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}
              >
                <span className="text-xs font-mono font-bold" style={{ color: "hsl(var(--primary))" }}>GENERATED PR DESCRIPTION</span>
