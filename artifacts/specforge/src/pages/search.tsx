...
const TYPE_META: Record<string, { label: string; icon: any; color: string; bg: string; border: string }> = {
  system_design:   { label: "System Design",   icon: Server,   color: "#A78BFA", bg: "rgba(124,58,237,0.12)", border: "rgba(124,58,237,0.35)" },
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            >
              <Sparkles className="w-4.5 h-4.5" style={{ color: "hsl(263,90%,70%)" }} />
            </div>
          </div>
